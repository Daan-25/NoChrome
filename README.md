...
## Build (macOS)
```bash
brew install cmake pkg-config sdl2 sdl2_ttf sdl2_image openssl@3 git
cmake -S . -B build
cmake --build build
```
...
```bash
# Debian/Ubuntu
sudo apt-get install cmake g++ libsdl2-dev libsdl2-ttf-dev libsdl2-image-dev libssl-dev
